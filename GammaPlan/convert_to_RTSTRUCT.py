...
def convert(input_nifti_path: str, input_dicom_path: str, output_dicom_path: str, ROI_name: str):
...
def get_parser():
    ...
    parser.add_argument("ROI_name", help="Name of ROI and file")

    return parser.parse_args()

if __name__ == "__main__":
    p = get_parser()
    convert(p.input_nifti, p.input_dicom, p.output_dicom, p.ROI_name)
